...
// console.log(parse("28-Dec-2025","dd-MMM-yyyy",new Date()))

export const newDate = (value: string) => {
...
export const uomMultiplier = (uom: string) => {
	switch (uom) {
		...
		case "ANOT DATA REC":
			// new
		case "HOST CPU CORE PR MO":
		case "1 MNAG RSRC PR MO":
		case "PROC VID MIN":
		case "1M TOKN":
		case "AI DATA PTFM UNIT":
		case "UNIV CRED CNSP":
			return 1;
		...
		case "AI UN PR HR":
			// new
		case "MAC SVR PR HR":
		case "GB STG PER HOUR":
		case "GPU MNTR UNIT PR HR":
		case "EPT PER HR":
		case "CLST HR":
			return 730;
		default:
